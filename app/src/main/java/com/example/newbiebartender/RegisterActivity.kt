    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.registerButtonRegister
            .setOnClickListener(View.OnClickListener {
                ...
                val ripetipasswords =
                    binding.editTextTextPasswordConfirm.text.toString().trim { it <= ' ' }
                    ...
                    if (TextUtils.isEmpty(emails)) {
                        if (TextUtils.isEmpty(passwords)) {
                            if (TextUtils.isEmpty(ripetipasswords)) {
                                binding.editTextTextPasswordConfirm.error =
                                    "E' necessario ripetere la password"
                            }
                ...
                if (!TextUtils.equals(passwords, ripetipasswords)) {
                    binding.editTextTextPasswordConfirmLayout.error =
                        "La password ripetuta e' errata"
                    return@OnClickListener
                }
